...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'journalApp';
    ...
    'jhipster.mail.from' = 'journalApp@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'journalApp API';
    'jhipster.swagger.description' = 'journalApp API documentation';
    ...
    'eureka.instance.appname' = 'journalApp';
    'eureka.instance.instanceId' = 'journalApp:${random.value}';
